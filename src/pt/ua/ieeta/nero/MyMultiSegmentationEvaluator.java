...
/**
 * Evaluate segmentation f1 for several different tags (marked in OIB format). For example, tags might be B-PERSON
 * I-PERSON O B-LOCATION I-LOCATION O...
 *
...
/**
 * Evaluates a transducer model, computes the precision, recall and F1 scores; considers segments that span across
 * multiple tokens.
 */
public class MyMultiSegmentationEvaluator extends TransducerEvaluator {
    ...
    public MyMultiSegmentationEvaluator(InstanceList[] instanceLists, String[] instanceListDescriptions,
    ...
    public MyMultiSegmentationEvaluator(InstanceList instanceList1, String description1,
            Object[] segmentStartTags, Object[] segmentContinueTags) {
     ...
     * {@link Transducer}. If predictedSequence is null, don't include in stats (useful for error analysis).
     *
