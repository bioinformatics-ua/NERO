...
public class MyCRFTrainerByLikelihoodAndGE2 extends TransducerTrainer {
  ...
  public MyCRFTrainerByLikelihoodAndGE2(CRF crf, ArrayList<GEConstraint> constraints, StateLabelMap map) {
    this.crf = crf;
