...
public class WordShape extends Pipe implements Serializable {
    ...
    public Instance pipe(Instance carrier) {
        ...
        for (int i = 0; i < ts.size(); i++) {
            ...
            //if (!typeI.equals(""))
            /*if (!typeI.equalsIgnoreCase("")) {
                t.setFeatureValue("WordShapeI=" + typeI, 1.0);
            }*/

            //if (!typeII.equals(""))
            if (!typeII.equalsIgnoreCase("")) {
                t.setFeatureValue("WordShapeII=" + typeII, 1.0);
            }

            //if (!typeIII.equals(""))

            if (!typeIII.equalsIgnoreCase("")) {
    ...
    /**
     * Convert an integer to the respective character representation. Used to generate Word Shape Type II.
     *
     * @param n The number.
